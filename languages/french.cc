    ...
    while(1) {
        ...
        while(1) {
            ...
            lab3:
                ...
                c++;
                ket = c;
                if (in_grouping_U(g_v, 97, 251, 0)) goto lab7;
...
int Xapian::InternalStemFrench::r_postlude() {
    ...
    while(1) {
        int c1 = c;
        bra = c;
        if (c >= l || p[c + 0] >> 5 != 2 || !((35652096 >> (p[c + 0] & 0x1f)) & 1)) among_var = 4; else
...
int Xapian::InternalStemFrench::r_standard_suffix() {
    ...
    switch (among_var) {
        ...
        case 2:
            ...
            {   int m1 = l - c; (void)m1;
                ket = c;
                if (!(eq_s_b(2, s_8))) { c = l - m1; goto lab0; }
                bra = c;
                {   int m2 = l - c; (void)m2;
                    {   int ret = r_R2();
                        if (ret == 0) goto lab2;
            ...
            {   int m3 = l - c; (void)m3;
                ...
                switch (among_var) {
                    case 1:
                        ...
                        ket = c;
                        if (!(eq_s_b(2, s_13))) { c = l - m3; goto lab3; }
                        bra = c;
                        {   int ret = r_R2();
                            if (ret == 0) { c = l - m3; goto lab3; }
                            if (ret < 0) return ret;
        ...
        case 8:
            ...
            {   int m8 = l - c; (void)m8;
                ket = c;
                if (!(eq_s_b(2, s_18))) { c = l - m8; goto lab11; }
                bra = c;
                {   int ret = r_R2();
                ...
                ket = c;
                if (!(eq_s_b(2, s_19))) { c = l - m8; goto lab11; }
                bra = c;
                {   int m9 = l - c; (void)m9;
                    {   int ret = r_R2();
                        if (ret == 0) goto lab13;
...
int Xapian::InternalStemFrench::r_residual_suffix() {
    ...
    {   int mlimit3;
        ...
        mlimit3 = lb; lb = I_pV;
        ket = c;
        among_var = find_among_b(s_pool, a_7, 7, 0, 0);
        ...
        switch (among_var) {
            ...
            case 3:
                ...
                break;
            case 4:
                if (!(eq_s_b(2, s_27))) { lb = mlimit3; return 0; }
                {   int ret = slice_del();
                    if (ret < 0) return ret;
                }
                break;
...
int Xapian::InternalStemFrench::r_un_accent() {
    ...
    ket = c;
    {   int m1 = l - c; (void)m1;
        if (!(eq_s_b(2, s_28))) goto lab2;
        goto lab1;
    lab2:
        c = l - m1;
        if (!(eq_s_b(2, s_29))) return 0;
    }
lab1:
    bra = c;
            ...
            lab3:
                ...
                {   int m6 = l - c; (void)m6;
                    ...
                    {   int m7 = l - c; (void)m7;
                        ...
                        c--;
                        bra = c;
                        {   int ret = slice_from_s(1, s_31);
                            if (ret < 0) return ret;
                        }
                        goto lab7;
                    lab8:
                        c = l - m7;
                        if (!(eq_s_b(2, s_32))) { c = l - m6; goto lab6; }
                        bra = c;
